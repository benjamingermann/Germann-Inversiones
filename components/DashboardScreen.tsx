...
const SkeletonPrice = () => (
  <div className="flex flex-col items-end gap-1.5">
    <div className="h-7 w-24 bg-white/5 rounded-lg animate-pulse relative overflow-hidden">
    ...
    <div className="h-3 w-16 bg-white/5 rounded-md animate-pulse"></div>
  </div>
);
        ...
        <div className="lg:col-span-8 flex flex-col gap-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <section className="bg-gradient-to-br from-surface-dark to-background-dark p-8 rounded-[2.5rem] border border-white/10 flex flex-col justify-center relative overflow-hidden shadow-2xl min-h-[200px]">
              ...
              <span className="text-[10px] font-bold text-gray-400 mb-2 uppercase tracking-[0.2em]">Patrimonio Neto (u$s)</span>
              ...
              <p className="text-[10px] text-gray-500 font-bold uppercase tracking-widest italic">Dólar MEP: ${mepRate.toLocaleString('es-AR')}</p>
            </section>
            ...
            >
              ...
              <div className="relative mt-4">
                <p className="text-gray-300 text-sm font-bold tracking-tight">Viendo el mercado</p>
                <div className="flex items-center gap-2 text-[#4FBBEB] mt-1 font-black text-[10px] uppercase tracking-widest">
                  ABRIR AHORA PLAY <span className="material-symbols-outlined text-sm">open_in_new</span>
                </div>
              </div>
            </section>
          </div>
          ...
          <section className="flex flex-col gap-6">
            <div className="flex justify-between items-center px-2">
              <h3 className="text-xl font-black text-white tracking-tight">Tus Acciones</h3>
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              {assets.length === 0 && (
                <div className="p-12 text-center border-2 border-dashed border-white/5 rounded-[2.5rem] bg-white/[0.02]">
                   <p className="text-gray-500 font-bold italic">Tu cartera está vacía. Añade tus primeras acciones.</p>
                </div>
              )}
            </div>
          </section>
        ...
        <div className="lg:col-span-4 flex flex-col gap-8">
          <section className="bg-surface-dark/30 p-8 rounded-[2.5rem] border border-white/5 backdrop-blur-sm shadow-xl">
            <div className="flex items-center justify-between mb-8 px-2">
              <h3 className="text-[10px] font-black text-gray-500 uppercase tracking-[0.2em]">Dólar Argentino</h3>
              <div className="flex items-center gap-1.5 px-2 py-0.5 bg-primary/10 rounded-full border border-primary/20">
                ...
                <span className="text-[8px] font-bold text-primary">EN VIVO</span>
              </div>
            </div>
            <div className="flex flex-col gap-4">
              {[
                ...
                <div key={i} className="flex items-center justify-between p-5 bg-background-dark/40 rounded-2xl border border-white/5 group shadow-sm transition-all hover:bg-white/[0.05]">
          ...
          <section className="bg-gradient-to-br from-primary/10 to-transparent p-10 rounded-[2.5rem] border border-primary/10 relative overflow-hidden">
            <h3 className="text-white text-xl font-black mb-4 tracking-tight italic">IA Germann</h3>
            <p className="text-sm text-gray-400 leading-relaxed mb-8 font-medium italic opacity-80">
              "Papá, ahora usamos Gemini Flash. Las consultas deberían ser casi instantáneas."
            </p>
            <button 
              onClick={onAddMoney}
              disabled={isSyncing}
            ...
            >
              {isSyncing ? 'Buscando...' : 'Forzar Sincro'}
            </button>
          </section>
        </div>
      </main>
